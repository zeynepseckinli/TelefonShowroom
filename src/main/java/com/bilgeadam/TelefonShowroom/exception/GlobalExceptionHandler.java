...
import static com.bilgeadam.TelefonShowroom.exception.ErrorType.*;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(TelefonShowroomException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleMonolitSpotifyException(TelefonShowroomException exception){
